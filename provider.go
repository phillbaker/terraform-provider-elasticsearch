...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"elasticsearch_opendistro_policy":         resourceElasticsearchOpendistroPolicy(),
			"elasticsearch_opendistro_policy_mapping": resourceElasticsearchOpendistroPolicyMapping(),
		},
